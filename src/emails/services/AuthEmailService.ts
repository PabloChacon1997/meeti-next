...
import { renderVerificationEmail, renderVerificationEmailText } from "../templates/VerficationEmail";
import { PasswordResetEmailData, VerificationEmailData } from "../types/email.types";
import { EmailService } from "./EmailService";


export class AuthEmailService {
  static async sendVerificationEmal(data: VerificationEmailData): Promise<void> {
