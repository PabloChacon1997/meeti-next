...
export default async function UpcomingCommunityMeetis({ communityId }: Props) {
  const meetis = await communityService.getUpcomingMeetisByCommunityId(communityId);
  return (
    <section className="max-w-7xl mx-auto py-10">
      <Heading level={2} className="text-center">Proximos meetis de esta communidad</Heading>
